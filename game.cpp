...
initwindow(1200,800,"legend");
 readimagefile("football.JPEG",0,0,640,480);
//sound();
    int cursor_y = 130;
    char ch;
    while(1)
    {
       ...
       // setbkcolor(BLACK);
        ...
        setcolor(3);
        outtextxy(200,160,"Help");setcolor(4);
        outtextxy(200,190,"Select Level");setcolor(5);
        outtextxy(200,220,"Highscore");setcolor(6);
        outtextxy(200,250,"Exit");
         setcolor(RED);
        outtextxy(157,cursor_y,"|");
        setlinestyle(3,0,3);
        line(160,cursor_y+2,330,cursor_y+2);
        line(160,cursor_y+27,330,cursor_y+27);
         outtextxy(330,cursor_y,"|");
        ...
        if(cursor_y < 130) {cursor_y=250;}
          ...
          setcolor(BLACK);
        outtextxy(157,cursor_y,"|");setlinestyle(3,0,3);
        line(160,cursor_y+2,330,cursor_y+2);
        line(160,cursor_y+27,330,cursor_y+27);
         outtextxy(330,cursor_y,"|");
    }
...
//PlaySound(TEXT("ape_the_bass.wav"),0,SND_SYNC);goto brea;
        }//brea:
        maxx = getmaxx();
        maxy = getmaxy()-50;
        setcolor(WHITE);
   ...
   sprintf(ara,"spd: %d",spd);
        setcolor(WHITE);
        outtextxy(250,maxy+10,ara);
        delay(spd);
...
void sound()
{
    PlaySound(TEXT("ape_the_bass.wav"),0,SND_SYNC);
}
